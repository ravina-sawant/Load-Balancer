...
resource "aws_instance" "web_server_1" {
  ami             = "ami-04b4f1a9cf54c11d0"  # Update with the correct AMI ID (e.g., Ubuntu)
  instance_type   = "t2.micro"                # Choose instance type
  key_name        = "ravinakey"                 # Use your existing SSH key pair name
...
resource "aws_lb_target_group" "nlb_target_group" {
  ...
  port     = 80
  protocol = "TCP"
  vpc_id   = "vpc-0cd62ea0489a03604"  # Replace with your VPC ID
...
resource "aws_lb" "nlb" {
  ...
  subnets            = ["subnet-09ea2ca6eed537925", "subnet-0c4663aadbf4d89d5", "subnet-0a3d041820b18dfcf"]  # Replace with your subnet IDs
